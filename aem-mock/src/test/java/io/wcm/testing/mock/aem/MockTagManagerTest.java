...
public class MockTagManagerTest {
  ...
  public void setUp() throws Exception {
    ...
    context.load().json("/json-import-samples/tags.json", "/content/cq:tags");
  ...
  public void testGetPageTags() {
    ...
    assertTrue(containsPath(pageTags, "/content/cq:tags/default/tagA"));
    assertTrue(containsPath(pageTags, "/content/cq:tags/wcmio/aem/api"));

    page = page.listChildren().next();
    pageTags = page.getTags();
    assertNotNull(pageTags);
    assertEquals(2, pageTags.length);
    assertTrue(containsPath(pageTags, "/content/cq:tags/default/tagB"));
    assertTrue(containsPath(pageTags, "/content/cq:tags/wcmio/nondescript"));
  ...
  public void testGetNamespaces() {
    ...
    assertTrue(containsPath(namespaces, "/content/cq:tags/default"));
    assertTrue(containsPath(namespaces, "/content/cq:tags/wcmio"));

    Iterator<Tag> namespacesIter = tagManager.getNamespacesIter();
    assertNotNull(namespacesIter);
    assertTrue(namespacesIter.hasNext());
    assertEquals("/content/cq:tags/default", namespacesIter.next().getPath());
    assertTrue(namespacesIter.hasNext());
    assertEquals("/content/cq:tags/wcmio", namespacesIter.next().getPath());
  ...
  public void testCreateTag() throws InvalidTagFormatException, PersistenceException {
    ...
    assertEquals("/content/cq:tags/wcmio", existing.getPath());
    ...
    assertEquals("/content/cq:tags/default/wcmio", newTag.getPath());
    ...
    assertNotNull(newTag);
    assertEquals("/content/cq:tags/wcmio/new", newTag.getPath());
  ...
  public void testFind() {
    ...
    resources = tagManager.find("/content", new String[]{"wcmio:nondescript", "/content/cq:tags/default"}, false);
    assertNotNull(resources);
    assertEquals(0, resources.getPosition());
    assertTrue(resources.hasNext());
    assertEquals(1, resources.getSize());
    ...
    resources = tagManager.find("/content", new String[]{"wcmio:nondescript", "/content/cq:tags/default"}, true);
    assertNotNull(resources);
    assertEquals(0, resources.getPosition());
    assertTrue(resources.hasNext());
    assertEquals(2, resources.getSize());
    ...
    resources = tagManager.find("/content", new String[]{"wcmio:nondescrip", "/content/cq:tags/default"}, true);
